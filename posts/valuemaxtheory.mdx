...
the problem of building a successful business in any industry can be reduced to the problem of maximizing the value you provide to others.


```math
\text{successful business} = max(value)
```

## how do we define value?

The value of any small business can be defined with the following equations:

The value a business provides it's customers[^1]
...
The value of a SaaS business (< $1m ARR)[^2]
```math
...
## great. math equations... how does this help me?

there's a ton of nuance missing but the above equations convey the overall theory.

ill add more nuance as time goes on but if you already vibe with the general theory, please open a PR on github to add more detail to this!

the real fun happens when you learn to change things in the real world resulting in the value you provide to go up. I'd love to start collecting stories and real examples of things people have done to increase value in their own businesses and lives.
...
[^1]: Based on the value equation by Alex Hormozi. Discussed extensively in his book [$100m Offers](https://www.goodreads.com/en/book/show/58612786)
[^2]: Median valuation multiples are subject to change based on market conditions and should be used as a guideline rather than a strict rule. Using median valuation multiples taken from [acquire.com 2024 business acquisition report.](https://blog.acquire.com/acquire-biannual-acquisition-multiples-report-2024/)